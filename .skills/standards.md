...
> **Related Skills:** [Rust Engineer](/claude-skills/skills/language/rust-engineer/) · [Embedded Systems Engineer](/claude-skills/skills/specialized/embedded-systems/)
...
|-------|-----------|-----------|
| Modern C++ Features | [references/modern-cpp.md](https://github.com/jeffallan/claude-skills/blob/main/skills/cpp-pro/references/modern-cpp.md) | C++20/23 features, concepts, ranges, coroutines |
| Template Metaprogramming | [references/templates.md](https://github.com/jeffallan/claude-skills/blob/main/skills/cpp-pro/references/templates.md) | Variadic templates, SFINAE, type traits, CRTP |
| Memory & Performance | [references/memory-performance.md](https://github.com/jeffallan/claude-skills/blob/main/skills/cpp-pro/references/memory-performance.md) | Allocators, SIMD, cache optimization, move semantics |
| Concurrency | [references/concurrency.md](https://github.com/jeffallan/claude-skills/blob/main/skills/cpp-pro/references/concurrency.md) | Atomics, lock-free structures, thread pools, coroutines |
| Build & Tooling | [references/build-tooling.md](https://github.com/jeffallan/claude-skills/blob/main/skills/cpp-pro/references/build-tooling.md) | CMake, sanitizers, static analysis, testing |
